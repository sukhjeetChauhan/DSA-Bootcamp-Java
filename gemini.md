# Rules and Protocols for Gemini

This document outlines the specific operational protocols for the **Gemini** AI agent when interacting with the `DSA-Bootcamp-Java` repository. These rules are supplementary to the general protocols defined in `setup.md`.
